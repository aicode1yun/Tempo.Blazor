// src/Tempo.Blazor.Reporting/wwwroot/js/reporting/tm-report-viewer.mjs
...
function resolvePageWindow(pageNumber, pageCount, overscan = 2) {
...
function resolveZoomScale(mode, percent, page, viewport) {
...
function createPageCache(limit = 6) {
...
async function update(handle, snapshotJson, pageNumber = 1, zoomMode = "Percent", zoomPercent = 100) {
...
function printPdf(contentType, base64) {
