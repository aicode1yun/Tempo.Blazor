...
public class MockNotionDatabaseProvider : INotionDatabaseProvider
{
    // ── Stable IDs ────────────────────────────────────────────────────────────
    ...
    public MockNotionDatabaseProvider()
    {
    ...
    private static List<DatabaseRecord> BuildRecords()
    {
        ...
        [
            ...
            Make("Security audit",                    "Backlog",     "Critical", now.AddDays(21),  ["tag-testing",  "tag-backend"],          0,   false, "dave"),
