...
/// <summary>Default renderer for document toolbar grid pickers.</summary>
public sealed class DocumentToolbarGridPickerRenderer : IDocumentToolbarItemRenderer
{
    /// <inheritdoc />
    public DocumentToolbarItemKind Kind => DocumentToolbarItemKind.GridPicker;
    ...
    public RenderFragment Render(DocumentToolbarRenderContext context) => builder =>
    {
        ...
        builder.AddAttribute(3, "aria-haspopup", "grid");
