...
public static class DocumentEditorBuiltInToolbar
{
    ...
    [
        ...
        Item("insertEquation", "insertEquation", "superscript", "TmDocumentEditor_InsertEquation", DocumentToolbarItemKind.Button, DocumentToolbarTab.Insert, "insert", 30, ToolbarItemPriority.Secondary),
        Item("insertSymbol", "insertSymbol", "pilcrow", "TmDocumentEditor_InsertSymbol", DocumentToolbarItemKind.Button, DocumentToolbarTab.Insert, "insert", 35, ToolbarItemPriority.Secondary),
        ...
        Item("mathInsertEquation", "insertEquation", "superscript", "TmDocumentEditor_InsertEquation", DocumentToolbarItemKind.Button, DocumentToolbarTab.Math, "math", 10, ToolbarItemPriority.Primary),
