...
/// <summary>Stable string identifiers for document editor floating UI layers registered in <see cref="DocumentFloatingLayerStack"/>.</summary>
internal static class FloatingLayerId
{
    ...
    public const string VersionDialog = "version-dialog";
    public const string CompareDialog = "compare-dialog";
}
