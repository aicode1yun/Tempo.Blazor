...
/// <summary>
/// Self-contained contenteditable blockquote. Owns its JS keyboard-handler lifecycle.
/// Mirrors TmNotionTextBlock — [JSInvokable] names match notion-editor.js;
/// EventCallback parameters use distinct names to avoid C# conflicts.
/// </summary>
public partial class TmNotionQuoteBlock : ComponentBase, IAsyncDisposable
{
    // ── DI ───────────────────────────────────────────────────────────────────
    ...
    private DotNetObjectReference<TmNotionQuoteBlock>?  _dotNetRef;
