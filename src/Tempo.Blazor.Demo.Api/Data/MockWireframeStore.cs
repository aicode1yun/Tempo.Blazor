...
public class MockWireframeStore
{
    ...
    private static WireframeDocument BuildDashboard() => new()
    {
        ...
        [
            ...
            MakeEl("TmStatCard",    "stat1",      264,  72, 260,  96, ("label", "Total Users"),    ("value", "12,430")),
            MakeEl("TmStatCard",    "stat2",      544,  72, 260,  96, ("label", "Revenue"),        ("value", "$84,210")),
            MakeEl("TmStatCard",    "stat3",      824,  72, 260,  96, ("label", "Active Orders"),  ("value", "1,284")),
            MakeEl("TmStatCard",    "stat4",     1104,  72, 260,  96, ("label", "Issues"),         ("value", "7")),
