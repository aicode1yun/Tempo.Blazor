...
/// <summary>Default renderer for document toolbar split buttons.</summary>
public sealed class DocumentToolbarSplitButtonRenderer : IDocumentToolbarItemRenderer
{
    /// <inheritdoc />
    public DocumentToolbarItemKind Kind => DocumentToolbarItemKind.SplitButton;
