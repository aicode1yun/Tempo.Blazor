...
/// </para>
/// <para>
/// The bundle is regenerated by the <c>BundleCssFiles</c> target of the project this test references,
/// so the file read here is rebuilt from the current sources before the test runs — the assertion is
/// about today's bundler output, not about a stale committed artefact.
/// </para>
/// </summary>
