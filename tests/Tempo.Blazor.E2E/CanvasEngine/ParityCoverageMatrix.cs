...
internal static class ParityCoverageMatrix
{
    ...
    [
        ...
        new("14", "Tables", "insertTable, editTableCell, selectTable, tableProperties, undo, redo", "DocumentEditorCanvasTableE2ETests", "Table edits persist through the canvas document model.", "DocumentEditorCanvasTableE2ETests", "Table major interactions use screenshot and canvas cell selectors. insertTable is REALLY covered since Phase4_InsertTableFromToolbarGrid_RendersTypesAndPersists (command-layer plan phase 4) — earlier tests only exercised seeds that already contained tables, which masked the unregistered insertTable command."),
        new("15", "Images, drawings and object layout", "insertImage, updateImageLayout, resizeImage, dragImage, insertDrawing, setImageZOrder", "DocumentEditorCanvasImageE2ETests; DocumentEditorCanvasShapesDrawingsE2ETests", "Image and drawing objects save, reload and export through phase 15/19 providers.", "DocumentEditorCanvasImageE2ETests; DocumentEditorCanvasShapesDrawingsE2ETests", "Image/object selection, drag and resize have screenshot coverage."),
        ...
        new("E5", "Fields and cross references", "insertCaption, insertCrossReference, insertTableOfFigures, insertBibliography, updateAllFields", "DocumentEditorCanvasFieldsE2ETests; DocumentEditorCanvasImportExportE2ETests.Phase19_CanvasDocxExtendedEPhaseSmoke_PreservesAdvancedAnchorsAndScreenshots", "Fields and cross-reference targets save and reload.", "DocumentEditorCanvasFieldsE2ETests", "Updated field results and reference navigation have screenshots."),
